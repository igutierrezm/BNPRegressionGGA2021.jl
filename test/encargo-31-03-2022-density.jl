...
function fitmodel(y0, y1, x1, X0, X1; mcmcsize = 20000, censoring_rate = 0)
...
begin
    ...
    df, smpl = fitmodel(y0, y1, x1, X0, X1; mcmcsize = 20000, censoring_rate = .2)
    plot(df; figname = "figures/density-31-03-2022-ex-1")
end;
...
begin
    ...
    y0, y1, x1, X0, X1, f1 = preprocess(dy, x0raw, x1raw)
    df, smpl = fitmodel(y0, y1, x1, X0, X1; mcmcsize = 10, censoring_rate = .2)
    plot(df; figname = "figures/density-31-03-2022-ex-2")
end;
...
begin
    ...
    y0, y1, x1, X0, X1, f1 = preprocess(dy, x0raw, x1raw)
    df, smpl = fitmodel(y0, y1, x1, X0, X1; mcmcsize = 20000, censoring_rate = .2)
    plot(df; figname = "figures/density-31-03-2022-ex-3")
end;
...
begin
    ...
    y0, y1, x1, X0, X1, f1 = preprocess(dy, x0raw, x1raw)
    df, smpl = fitmodel(y0, y1, x1, X0, X1; mcmcsize = 20000, censoring_rate = .2)
    plot(df; figname = "figures/density-31-03-2022-ex-4")
end;
