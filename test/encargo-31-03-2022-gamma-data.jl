...
function simulate_sample(dy, filename)
...
begin
    Random.seed!(1)
    simulate_sample(Normal(x, 1), "data/2022-03-31-data-ex1.csv")
    simulate_sample(SkewNormal(2x, 4, 4), "data/2022-03-31-data-ex2.csv")
end;
