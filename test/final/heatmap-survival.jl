...
# begin 
#     dy(x) = Normal(x, 1)
#     filename = "data/final/survival-gamma-normal-freq-50.csv"
...
# begin 
#     dy(x) = LogNormal(x, 1)
#     filename = "data/final/survival-gamma-normal-freq-100.csv"
...
# begin 
#     dy(x) = Normal(x, 1)
#     filename = "data/final/survival-gamma-normal-freq-200.csv"
